...
void CCamera::Tick(_float fTimeDelta)
{
	...
	pPipeLine->Set_Transform(CPipeLine::D3DTS_PROJ, XMMatrixOrthographicLH(m_CameraDesc.fAspect* m_CameraDesc.fFovy, m_CameraDesc.fFovy, m_CameraDesc.fNear, m_CameraDesc.fFar));
